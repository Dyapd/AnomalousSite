...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2024 at 10:44 AM
...
(55, 'Allen Payad, High Head of Administration', 'Shock Troops Branch Office, A2 Facility', 'Regal Sword', '\r\n<b>Discovery: </b>\r\n</br>\r\n</br>\r\nThis was found in Kinnoull Hill, Scotland in the April 1966 by a local of the area. When they took hold of the sword, they were hit by mental suggestion that they are unworthy and a need to find a person worthy of the sword. They attempted to give the sword to a local teenager in Edinburgh. Saying that she is the chosen. The locals then arrested him, and then the local SDP branch was contacted.\r\n</br>\r\n</br>\r\n</br>\r\n<b>Description: </b>\r\n</br>\r\n</br>\r\nThe sword has a subjective cloak, but all descriptions have one in common and that is that they claim that the sword is fit for a king. When wielded by a someone it deems worthy, the user receives massive increases to their martial strength and a mastery of the sword. A side effect however, is that the user is mentally corrupted while they are in possession of the sword. They become assertive in their authority and are quick to challenge any opposition to it. Because of the manageable mental side-effects this anomaly has been cleared for agent use.\r\n', 'Object', 'Vicinity', 'Cooperative', 'ob004.jpg', 'OB-003'),
